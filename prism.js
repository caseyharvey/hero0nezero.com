    ...
    Prism = function (g) {
        var u = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            C = {
                ...
                util: {
                    encode: function (e) {
                        return e instanceof M ? new M(e.type, C.util.encode(e.content), e.alias) : "Array" === C.util.type(e) ? e.map(C.util.encode) : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                    },
                    type: function (e) {
                    ...
                    clone: function a(e, n) {
                        var r, t, i = C.util.type(e);
                        switch (n = n || {}, i) {
                            case "Object":
                                if (t = C.util.objId(e), n[t]) return n[t];
                                for (var l in r = {}, n[t] = r, e) e.hasOwnProperty(l) && (r[l] = a(e[l], n));
                                return r;
                            case "Array":
                                return t = C.util.objId(e), n[t] ? n[t] : (r = [], n[t] = r, e.forEach(function (e, t) {
                                    r[t] = a(e, n)
                                }), r);
                            default:
                                return e
                ...
                languages: {
                    ...
                    insertBefore: function (a, e, t, n) {
                        ...
                        return n[a] = i, C.languages.DFS(C.languages, function (e, t) {
                            t === s && e != a && (this[e] = i)
                        }), i
                    },
                    DFS: function e(t, a, n, r) {
                        ...
                        for (var l in t)
                            if (t.hasOwnProperty(l)) {
                                ...
                                var o = t[l],
                                    s = C.util.type(o);
                                "Object" !== s || r[i(o)] ? "Array" !== s || r[i(o)] || (r[i(o)] = !0, e(o, a, l, r)) : (r[i(o)] = !0, e(o, a, null, r))
                            }
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function (e, t, a) {
                    ...
                    for (var r, i = n.elements || e.querySelectorAll(n.selector), l = 0; r = i[l++];) C.highlightElement(r, !0 === t, n.callback)
                },
                highlightElement: function (e, t, a) {
                    for (var n, r, i = e; i && !u.test(i.className);) i = i.parentNode;
                    i && (n = (i.className.match(u) || [, ""])[1].toLowerCase(), r = C.languages[n]), e.className = e.className.replace(u, "").replace(/\s+/g, " ") + " language-" + n, e.parentNode && (i = e.parentNode, /pre/i.test(i.nodeName) && (i.className = i.className.replace(u, "").replace(/\s+/g, " ") + " language-" + n));
                    var l = {
                            element: e,
                            language: n,
                            grammar: r,
                        ...
                        o = function (e) {
                            l.highlightedCode = e, C.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, C.hooks.run("after-highlight", l), C.hooks.run("complete", l), a && a.call(l.element)
                        };
                                ...
                                for (var y = n, v = r; y < t.length; v += t[y].length, ++y) {
                                    ...
                                    if (!(k instanceof M)) {
                                        if (f && y != t.length - 1) {
                                            ...
                                            for (var b = x.index + (h ? x[1].length : 0), w = x.index + x[0].length, A = y, P = v, O = t.length; A < O && (P < w || !t[A].type && !t[A - 1].greedy); ++A)(P += t[A].length) <= b && (++y, v = P);
                                        ...
                                        if (x) {
                                            ...
                                            if (E.push(_), S && E.push(S), Array.prototype.splice.apply(t, E), 1 != N && C.matchGrammar(e, t, a, y, v, !0, o), i) break
                                        } else if (i) break
                                    }
                                }
                            }
        ...
        if (g.Prism = C, M.stringify = function (t, a, e) {
            ...
            var t = JSON.parse(e.data),
                ...
                n = t.code,
                r = t.immediateClose;
            g.postMessage(C.highlight(n, C.languages[a], a)), r && g.close()
        }, !1)), C;
